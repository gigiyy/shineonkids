myApp.factory('DataService',
    ...
    function($http, $mdDialog, $q, $route) {
      ...
      function insertBead(name, type, lotsize, price, name_jp, description) {
        var deferred = $q.defer();

        $http.post('/beads', {name:name, type:type, lotsize:lotsize, price:price, name_jp:name_jp, description:description})
          .success(function (data, status) {
            if (status === 200 ) {
              deferred.resolve();
            } else {
      ...
      function updateBead(name, type, lotsize, price, name_jp, description) {
        var deferred = $q.defer();

        $http.put('/beads', {name:name, type:type, lotsize:lotsize, price:price, name_jp:name_jp, description:description})
          .success(function (data, status) {
            if (status === 200 ) {
              deferred.resolve();
            } else {
