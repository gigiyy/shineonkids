		...
		db.serialize(function() {
			...
			stmt.finalize();
 			...
 			var beads = [
				...
				{'name':'Silver Bead', 'type':'Color', 'qty':200, 'lotsize':500, 'price':18, 'name_jp':'シルバー', 'desc':'ガーゼ交換'},
				...
				{'name':'A', 'type':'Alphabet', 'qty':200, 'lotsize':500, 'price':18, 'name_jp':'A', 'desc':''},
				{'name':'B', 'type':'Alphabet', 'qty':200, 'lotsize':500, 'price':18, 'name_jp':'B', 'desc':''},
				{'name':'C', 'type':'Alphabet', 'qty':200, 'lotsize':500, 'price':18, 'name_jp':'C', 'desc':''}
			];
